        ...
        <div className="layout__box">
          ...
          <div className="topics-page layout__body">
            ...
            <ul className="topics__list">
              <li>
                <a href="/topics" className="active">All <span>{topics.length}</span></a>
              </li>
              {topics.map(topic => (
                <li key={topic.id}>
                  <a href={`/home?q=${topic.name}`}>{topic.name} <span>{topic.room_set.length}</span></a>
                </li>
              ))}
            </ul>
          </div>
